<div class="header-top">
    ...
    <div class="header-bottom">
        <div class="wrap">
            ...
            <li class="active grid"><a href="Farmerindex.php">Home</a></li>
            <?php if (strlen($_SESSION['nmsuid']>0)) {?>
...
?>
               ...
               <!-- <li><a class="color6" href="Make_Order.php">Make Order</a></li>-->
                <li><a class="color7" href="Farmerscontact.php">Contact Us</a></li>
                      <?php if (strlen($_SESSION['nmsuid']==0)) {?>
