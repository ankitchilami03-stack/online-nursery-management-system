...
<div class="collapse" id="orders" data-bs-parent="#sidenavAccordion">
    <nav class="sb-sidenav-menu-nested nav">
        ...
        <a class="nav-link" href="not-deliver.php">Not Delivered</a>
        <a class="nav-link" href="cancelled-order.php">Cancelled Order</a>
    </nav>
</div>

<!-- Add Delivery Boy Section -->
<a class="nav-link collapsed" href="#" data-bs-toggle="collapse" data-bs-target="#deliveryboy" aria-expanded="false" aria-controls="deliveryboy">
    <div class="sb-nav-link-icon"><i class="fas fa-motorcycle"></i></div>
    Add Delivery Boy
    <div class="sb-sidenav-collapse-arrow"><i class="fas fa-angle-down"></i></div>
</a>
<div class="collapse" id="deliveryboy" data-bs-parent="#sidenavAccordion">
    <nav class="sb-sidenav-menu-nested nav">
        <a class="nav-link" href="add_delivery_boy.php">Add Delivery</a>
        <a class="nav-link" href="order_delivery_boy.php">Give Orders</a>
        <a class="nav-link" href="view_delivery_boy.php">View Orders</a>
    </nav>
</div>
